            ...
            <div className={`w-full overflow-y-auto overflow-x-hidden ${mobile ? 'h-[85vh]' : 'h-[80vh]'}`}>
                <form onSubmit={handleSubmit} className="flex mb-4 flex-col items-center">
                    ...
                    <div className="flex justify-end w-[95%]">
                        {boutLoading ? (
                            <label className="cursor-no-drop w-max relative mt-3 flex justify-center items-center bg-green-950 p-2 rounded text-gray-400">
                                <input type="submit" id="send" value='Soumettre' className='pointer-events-none' disabled />
                            ...
                            <label htmlFor="send" className="mt-3 cursor-pointer w-max flex justify-end bg-green-600 p-2 rounded text-white">
