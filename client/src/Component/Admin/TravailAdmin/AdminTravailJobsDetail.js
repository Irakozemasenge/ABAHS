                ...
                <div className='flex flex-wrap'>
                    <div className='w-full g p-3 rounded-xl h-max m-2'>
                        ...
                        <div className="flex flex-col md:flex-row mt-4">
                            <Link to="/travail" className="bg-blue-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mr-0 md:mr-3 mb-2 md:mb-0 transition duration-300 ease-in-out">Retourner</Link>
                            ...
                            <button onClick={handleDisable} className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mr-0 md:mr-3 mb-2 md:mb-0 transition duration-300 ease-in-out">Desactiver</button>
                            <Link to={`/travail/ajoutavantages/${id}`} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mr-0 md:mr-3 mb-2 md:mb-0 transition duration-300 ease-in-out">Ajouter Avantage</Link>
                        </div>
                                ...
                                {travailDetails.tavantages && travailDetails.tavantages.map((avantage, index) => (
                                    <li key={index} className="flex flex-col md:flex-row items-start md:items-center justify-between py-2 border-b border-gray-200">
                                        ...
                                        <div className="flex mt-2 md:mt-0 space-x-2">
                                            <button onClick={() => handleEditavantages(avantage.id, avantage.av)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded border border-blue-700">Modifier</button>
