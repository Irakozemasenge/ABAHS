...
function NavBarsVisaAdmin() {
    ...
    return (
        <div className='text-[20px]  h-[7vh] flex justify-between items-end'>
            ...
            >
                <Link className={`w-full border-b-2 pl-2 h-full flex items-end ${(url == "/visa" || url == "/visa/detail" || url == "/visa/modifier") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to='/visa'>
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/visa/ajouter") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to='/visa/ajouter' >
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/visa/command" || url == "/visa/command/detail") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to="/visa/command">
            ...
            >
                <Link className={`w-full  h-full flex items-end border-b-2 ${(url == "/visa/archive" || url == '/visa/archive/detail') && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to="/visa/archive">
                    {!mobile3 && <>Archive</>}
