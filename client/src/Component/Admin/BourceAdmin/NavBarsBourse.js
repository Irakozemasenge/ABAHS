...
function NavBarsBourse() {
    ...
    return (
        <div className='text-[20px]  h-[7vh] flex justify-between items-end'>
            ...
            >
                <Link className={`w-full border-b-2 pl-2 h-full flex items-end ${(url == "/bourse" || url == "/bourse/detail" || url == "/bourse/modifier") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to='/bourse'>
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/bourse/ajouter") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to='/bourse/ajouter' >
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/bourse/command" || url == "/bourse/command/detail") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to="/bourse/command">
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/bourse/valid" || url == "/bourse/valid/detail") && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to="/bourse/valid">
            ...
            >
                <Link className={`w-full  h-full flex items-end border-b-2 ${(url == "/bourse/archive" || url == '/bourse/archive/detail') && "border-fuchsia-600 hover:text-fuchsia-600 focus:text-fuchsia-600 text-fuchsia-600"}`} to="/bourse/archive">
                    {!mobile3 && <>Archive</>}
