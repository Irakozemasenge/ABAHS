                ...
                <div className='flex flex-wrap'>
                    <div className='w-full g p-3 rounded-xl h-max m-2'>
                        ...
                        <div className="flex flex-col md:flex-row mt-4">
                            <Link to="/bourse" className="bg-blue-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mr-0 md:mr-3 mb-2 md:mb-0 transition duration-300 ease-in-out">Retourner</Link>
