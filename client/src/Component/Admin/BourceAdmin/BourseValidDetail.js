                ...
                <div className='flex '>
                    <div className='w-full g p-3  rounded-xl h-max  m-2'>
                        ...
                        <div className='flex mt-4'>
                            <Link to='/bourse/valid' className='w-max mx-1 px-2 block hover:text-white focus:text-white text-center cursor-pointer py-1.5 mt-1 bg-fuchsia-600 text-white rounded'>
                                Retourner
                            </Link>
