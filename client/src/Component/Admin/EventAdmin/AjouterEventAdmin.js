                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center mb-5">
                    <div className="rounded-lg p-2 border border-blue-500  w-[90%]  sm:p-4">
                        {blocks.map((block, index) => (
                            <div key={index} className="justify_center rounded-xl w-full p-1 sm:p-4 mb-10 border border-fuchsia-700 flex flex-col">
                                ...
                                {!block.video && <label ref={inputRefs.current[index].photos} htmlFor={`photos_${index}`} className={`appearance-none outline-none focus:border focus:border-fuchsia-600 block cursor-pointer bg-transparent w-full  text-grey-darker border border-red rounded py-3 px-4 mb-3 `}>
                                    Photos
                                </label>
                                }
                                <input
                                ...
                                <textarea
                                    className="appearance-none block h-[15em] resize-none bg-transparent overflow-hidden outline-none focus:border focus:border-fuchsia-600 w-full bg-grey-lighter text-grey-darker border border-gray-400 rounded  p-2 mb-1"
                        ...
                        <button type="button" onClick={addBloc}
                            className="bg-fuchsia-600 cursor-pointer hover-bg-blue-700 text-white py-1 px-2  max-sm:text-xs sm:py-2 sm:px-4 rounded">
