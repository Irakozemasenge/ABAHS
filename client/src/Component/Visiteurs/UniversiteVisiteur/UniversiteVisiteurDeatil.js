...
function UniversiteVisiteurDeatil() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`https://speedreal.abahs-jobconnect.com/etude/postulertravail`, formData)
            .then(response => {
            ...
            <div className='flex  bg-gray-50 rounded'>
                <div className='w-full  sm:p-3 p-1 rounded-xl h-max  m-2'>
                    ...
                    <div className='mt-2 text-lg'>
                        ...
                        <div className='font-medium'>Pays: {etudeDetails.pays}</div>
                        <div className='font-medium'>Domaine: {etudeDetails.domaine}</div>
                        <div className='font-medium'>Niveau: {etudeDetails.niveau}</div>
                        <div className='font-medium'>Inscription: <span className='font-bold'>du {new Date(etudeDetails.createdAt).toLocaleDateString()} au {new Date(etudeDetails.fin).toLocaleDateString()}</span></div>
                    </div>
                    ...
                    <div className='text-[15px] sm:text-[17px] mt-4'>
                        <div id="Critere" className='text-[20px] font-bold'>Critere d'eligibilite</div>
                        <ul className='list-none'>
