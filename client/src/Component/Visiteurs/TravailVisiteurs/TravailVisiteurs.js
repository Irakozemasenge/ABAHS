    ...
    return (
        <>
            <div className={`relative  bg-gray-50 flex p-2 ${mobile1 ? 'flex-col-reverse' : 'flex-row-reverse'}`}>
                <div onSubmit={HundleSubmit} className={`h-full w-ull ${mobile1 ? 'w-full mt-5' : 'w-1/2   mt-10'}`}>
                    <div className={`mt-2 font-serif  ${mobile2 ? 'text-[25px] ' : mobile ? 'text-[40px] ' : 'text-[60px] '} w-full text-center`}>Recherche le travail à l'étranger</div>
