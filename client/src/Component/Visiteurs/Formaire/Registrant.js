            ...
            <div className={` bg-white  p-2 w-[35em] border shadow-2xl border-orange-600 sm: max-sm:w-[95%] rounded-3xl h-max`}>
                <div className="w-full flex justify-center items-center">
                    <div className="h-[10em] w-max max-sm:h-[7em] bg-orange-600   transition-all  relative overflow-hidden ml-3 rounded ">
                        <img draggable='false' src='image/abahs.jpg' alt="" className='h-full w-full  object-contain object-center' />
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} >
                    <div className={`flex mt-4 w-full  ${mobile ? 'flex-col' : ''} `}>
                        ...
                        <div className="mb-4 mx-1 w-1/2">
                            ...
                            <input
                                ...
                                className={`border rounded p-2 w-full  bg-transparent outline-none focus:border focus:border-orange-700 ${animationClassPrenom}`}
                                ref={prenomRef}
                                value={isPrenom}
                    ...
                    <div className={`flex ${mobile ? 'flex-col' : ''} `}>
                        <div className="mb-4 mx-1 w-1/2">
                            ...
                            <input
                                ...
                                className={`border rounded p-2 w-full  bg-transparent outline-none focus:border focus:border-orange-700 ${animationClassTel}`}
                                ref={telRef}
                                value={isTel}
                        ...
                        <div className="mb-4 mx-1 w-1/2">
                            ...
                            >
                                <input
                                    ...
                                    className={`border rounded p-2 w-full pr-7  bg-transparent outline-none focus:border focus:border-orange-700 ${animationClassConfirm}`}
                                    ref={passConfirmRef}
                                    value={isPassConfirm}
                    ...
                    {isProfil && <div className='w-[15em] h-[15em] border m-2 rounded-xl overflow-hidden border-orange-600'>
                        <img src={URL.createObjectURL(isProfil)} className='w-full h-full ' alt=' ' />
                    </div>
                    }
